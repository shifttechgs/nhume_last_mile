        ...
        <div class="footer-grid" style="padding-bottom:44px;border-bottom:1px solid rgba(255,255,255,0.055);margin-bottom:32px;">
            ...
            <div>
                <div style="margin-bottom:14px;">
                    <img src="/images/nhume_logo_dark_bg.png" alt="Nhume" style="height:100px;width:auto;">
                </div>
                <p style="font-family:'DM Sans',system-ui,sans-serif;font-size:13.5px;color:rgba(255,255,255,0.28);line-height:1.7;margin-bottom:22px;max-width:210px">Same-day errands and intercity parcels, moved by real people.</p>
